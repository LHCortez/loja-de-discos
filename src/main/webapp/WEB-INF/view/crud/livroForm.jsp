...
<tags:crudTemplate>
    ...
    <div class="tab-content crud-tab-content py-4 px-3 px-sm-4" id="myTabContent">
        ...
        <form:form modelAttribute="livro" action="${s:mvcUrl('CPC#createLivro').build()}" method="POST"
            ...
            <fieldset class="capa row mb-3">
                ...
                <div class="col-md-6 col-lg-4">
                    <input name="capaUrl" type="text" class="form-control" id="capa-url-input" value="${livro.capa}" required/>
                </div>
            </fieldset>
