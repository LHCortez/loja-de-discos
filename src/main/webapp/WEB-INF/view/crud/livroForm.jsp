...
<tags:crudTemplate>
    ...
    <div class="tab-content crud-tab-content py-4 px-sm-4" id="myTabContent">
        ...
        <form:form modelAttribute="livro" action="${pageContext.request.contextPath}/crud/product/create/livro" method="POST">
            <form:errors/>
            ...
            <fieldset class="capa row mb-3">
                ...
                <div class="col-md-6 col-lg-4">
                    <form:input required="true" path="capa" type="text" class="form-control" id="produto-capa" value="${livro.capa}"/>
